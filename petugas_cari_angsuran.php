...
$selek = $conn->query("SELECT id_pinjaman, id_anggota, besar_pinjaman, tanggal_pinjaman, tanggal_pelunasan, keterangan, lama_cicilan, sisa_pinjaman FROM pinjaman");
...
if ($selek->num_rows > 0) {
    while ($array = $selek->fetch_assoc()) {
        ...
        <tr>
            ...
            <td><a href='bayar_angsuran.php?id_pinjaman={$array['id_pinjaman']}'>Bayar</a></td>
        </tr>
        ";
    }
} else {
